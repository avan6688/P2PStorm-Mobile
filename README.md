...
class MainActivity : ComponentActivity() {
    companion object {
        ...
        // See https://docs.p2pstorm.vip/v2.1.0/types/p2p-media-loader-core.CoreConfig.html
    ...
    override fun onStop() {
        ...
        // See https://docs.p2pstorm.vip/v2.1.0/types/p2p-media-loader-core.DynamicCoreConfig.html
