package com.p2pstorm.sdk.parser
...
import com.p2pstorm.sdk.Constants.QueryParams
import com.p2pstorm.sdk.Constants.StreamTypes
import com.p2pstorm.sdk.Segment
import com.p2pstorm.sdk.Stream
import com.p2pstorm.sdk.UpdateStreamParams
...
internal class HlsManifestParser(
    ...
    private fun processSegment(
        ...
        // Search from last known position for O(n) instead of O(n²)
        var startIndex = manifestBuilder.indexOf(segmentUriInManifest, lastSearchIndex)
        if (startIndex == -1) {
            // Fallback: search from beginning
            startIndex = manifestBuilder.indexOf(segmentUriInManifest)
        }
        if (startIndex == -1) {
